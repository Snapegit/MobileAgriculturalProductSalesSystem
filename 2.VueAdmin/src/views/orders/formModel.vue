					...
					<el-col :span="12">
						<el-form-item label="团购编号" prop="groupno">
							<el-input class="list_inp" v-model="form.groupno" placeholder="团购编号"
								 type="text" 								:readonly="!isAdd||disabledForm.groupno?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.logistics = res.data.data.logistics?(res.data.data.logistics.replace(reg,'../../../cl78051113/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			form.value.tablename='nongchanpin'
			formVisible.value = true
		}
