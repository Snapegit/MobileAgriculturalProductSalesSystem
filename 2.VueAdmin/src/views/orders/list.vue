...
<template>
	<div>
		<div class="app-contain">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('orders'+(orderStatus?'/'+orderStatus:''),'购买数量统计')">购买数量统计</el-button>
				</div>
			</div>
			<br>
			<el-table
		...
		<!-- 统计图弹窗 -->
		<el-dialog v-model="echartVisible" :title="'购买数量统计'" width="70%">
